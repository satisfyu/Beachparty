...
public class VillagersFabric {
    ...
    public static final VillagerProfession BARKEEPER = Registry.register(Registries.VILLAGER_PROFESSION, new ResourceLocation("beachparty", "barkeeper"), VillagerProfessionBuilder.create().id(new ResourceLocation("beachparty", "barkeeper")).workstation(ResourceKey.create(Registries.POINT_OF_INTEREST_TYPE, BARKEEPER_POI_IDENTIFIER)).build());

    public static final VillagerType BEACH = Registry.register(Registries.VILLAGER_TYPE, new ResourceLocation("beachparty", "beachparty"), new VillagerType("beachparty"));
    ...
    public static void init() {
        ...
        VillagerType.BY_BIOME.put(ResourceKey.create(Registries.BIOME_REGISTRY, new ResourceLocation("beach")), BEACH);
