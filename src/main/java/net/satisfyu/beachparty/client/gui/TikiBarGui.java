...
public class TikiBarGui extends HandledScreen<TikiBarGuiHandler> {

    private static final Identifier BG = new BeachpartyIdentifier("textures/gui/tiki_bar_gui.png");
