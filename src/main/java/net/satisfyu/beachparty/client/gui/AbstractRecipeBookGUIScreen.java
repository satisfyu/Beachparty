...
import net.satisfyu.beachparty.client.recipebook.AbstractPrivateRecipeScreenHandler;
...
public abstract class AbstractRecipeBookGUIScreen<T extends AbstractPrivateRecipeScreenHandler> extends HandledScreen<T> {
    ...
    static {
        RECIPE_BUTTON_TEXTURE = new BeachpartyIdentifier("textures/gui/recipe_button.png");
    }
}
