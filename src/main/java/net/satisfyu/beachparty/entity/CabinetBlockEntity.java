...
import net.satisfyu.beachparty.block.CabinetBlock;
...
public class CabinetBlockEntity extends LootableContainerBlockEntity {
    ...
    protected Text getContainerName() {
        return Text.translatable("beachparty.container.cabinet");
    }
    ...
    public void setOpen(BlockState state, boolean open) {
        if(state.getBlock() instanceof CabinetBlock rack) rack.playSound(world, this.getPos(), open);
