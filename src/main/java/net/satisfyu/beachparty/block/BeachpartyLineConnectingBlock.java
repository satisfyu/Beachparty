...
import net.satisfyu.beachparty.util.BeachpartyProperties;
...
public class BeachpartyLineConnectingBlock extends Block {
    ...
    public BeachpartyLineConnectingBlock(Settings settings) {
        super(settings);
        this.setDefaultState(((this.stateManager.getDefaultState().with(FACING, Direction.NORTH)).with(TYPE, BeachpartyLineConnectingType.NONE)));
    }
