...
public class MiniFridgeBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof MiniFridgeBlockEntity) {
                ItemScatterer.spawn(world, pos, (MiniFridgeBlockEntity)blockEntity);
    ...
    public void appendTooltip(ItemStack itemStack, BlockView world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(Text.translatable("tooltip.beachparty.fridge").formatted(Formatting.WHITE));
