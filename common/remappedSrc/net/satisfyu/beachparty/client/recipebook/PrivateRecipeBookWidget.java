package net.satisfyu.beachparty.client.recipebook;
...
import net.satisfyu.beachparty.client.screen.recipe.PrivateRecipeBookRecipeArea;
...
public abstract class  PrivateRecipeBookWidget extends GuiComponent implements PlaceRecipe<Ingredient>, Widget, GuiEventListener, RecipeShownListener {
    ...
    protected void setOpen(boolean opened) {
        ...
        this.open = opened;
        BeachPartyClient.rememberedRecipeBookOpen = opened;
        if (!opened) {
    ...
    private boolean isGuiOpen() {
        return BeachPartyClient.rememberedRecipeBookOpen;
    }
    ...
    private boolean toggleFilteringCraftable() {
        boolean bl = !BeachPartyClient.rememberedCraftableToggle;
        BeachPartyClient.rememberedCraftableToggle = bl;
        return bl;
    }
    ...
    private void refreshResults(boolean resetCurrentPage) {
        ...
        if (BeachPartyClient.rememberedCraftableToggle) {
    ...
    public void reset() {
        ...
        this.toggleCraftableButton = new StateSwitchingButton(i + 110, j + 12, 26, 16, BeachPartyClient.rememberedCraftableToggle);
