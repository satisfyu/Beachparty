...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> COCONUT_HANGING_BLOCK = registerWithoutItem("coconut_hanging_block", () -> new Block(BlockBehaviour.Properties.of(Material.BAMBOO)));
